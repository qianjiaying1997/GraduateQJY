...
class ResNetFc(nn.Module):
  def __init__(self, use_bottleneck=False, bottleneck_dim=256, new_cls=True, class_num=100):
    super(ResNetFc, self).__init__()
    model_resnet = models.resnet50(pretrained=True)
    # model_resnet.load_state_dict(torch.load('./models/resnet18-5c106cde.pth'))
